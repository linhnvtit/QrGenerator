...
class HandleResultFragment : Fragment() {
    ...
    private val requestSubjects: HashMap<String, (Permission) -> Unit> = HashMap()
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == PERMISSION_REQUEST_CODE) {
            permissions.forEachIndexed { index, permission ->
                val permissionSubject = requestSubjects[permission]
                ...
                requestSubjects.remove(permission)
            }
        }
    }
    ...
    fun addPermissionSubject(permission: String, subject: (Permission) -> Unit) {
        requestSubjects[permission] = subject
    }

    fun getPermissionSubject(permission: String): ((Permission) -> Unit)? =
        requestSubjects[permission]
}